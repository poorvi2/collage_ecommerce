...
$qry1= "select * from product order by pro_price ASC ";	
...
<body> 
	...
	<div class="banner banner11">
		<div class="container">
			<h2>Check Products <span>By </span> Pricing</h2> 
		</div>
	</div> 
	<!-- breadcrumbs -->
						...
						<div class="w3ls_mobiles_grid_left_grid_sub">
							<div class="panel-group" >
							  ...
							  <div class="panel panel-default">
								<div class="panel-heading" role="tab">
								  <h4 class="panel-title asd">
									<a class="pa_italic collapsed" role="button"  href="rating.php" >
									  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>Rating
									</a>
								  </h4>
								</div>
